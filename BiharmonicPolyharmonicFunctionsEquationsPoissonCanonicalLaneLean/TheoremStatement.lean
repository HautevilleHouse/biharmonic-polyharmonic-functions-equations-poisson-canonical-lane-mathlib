import BiharmonicPolyharmonicFunctionsEquationsPoissonCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "biharmonic polyharmonic Poisson admissible-class closure via bridge and gate",
